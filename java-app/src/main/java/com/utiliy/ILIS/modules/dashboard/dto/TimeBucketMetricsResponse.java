...
@NoArgsConstructor
@AllArgsConstructor
public class TimeBucketMetricsResponse {
    ...
    public static TimeBucketMetricsResponse fromProjection(TimeBucketMetricsProjection proj) {
        if (proj == null) return null;
        return TimeBucketMetricsResponse.builder()
                ...
                .requestsPerSecond(proj.getRequestsPerSecond() != null ? proj.getRequestsPerSecond() : 0.0)
                .totalTokens(proj.getTotalTokens() != null ? proj.getTotalTokens() : 0L)
                .tokensPerSecond(proj.getTokensPerSecond() != null ? proj.getTokensPerSecond() : 0.0)
                .build();
    }
}
